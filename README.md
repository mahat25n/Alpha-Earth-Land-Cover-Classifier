...
- **Year range selection** — Year From and Year To dropdowns (2020–2023) run the analysis across multiple years
...
- **Year × Algorithm comparison table** — When multiple years or algorithms are selected, a styled HTML table summarises Accuracy, ROC AUC, Precision, Recall, F1, and Top Embedding for every combination
- **Best model highlight** — The row with the highest accuracy is marked with ★ Best and highlighted in green
...
6. **Configure algorithm settings**:
   ...
   - *Year From / Year To* — Set a single year or a range (2020–2023)
...
9. **Download outputs**:
   ...
   - **Download Comparison Table as CSV** — Exports the year × algorithm comparison table (visible in multi-mode)
...
If you use this app or build upon it, please cite the original Google AlphaEarth embeddings dataset:
